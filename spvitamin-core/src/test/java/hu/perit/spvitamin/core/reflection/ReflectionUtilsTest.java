...
class ReflectionUtilsTest
{
    ...
    void testGettersOf()
    {
        ...
        assertThat(getters).extracting(Method::getName)
    ...
    void testSettersOf()
    {
        ...
        assertThat(setters).extracting(Method::getName)
    ...
    void testIsGetter() throws NoSuchMethodException
    {
        ...
        assertThat(ReflectionUtils.isGetter(getMethod)).isTrue();
        assertThat(ReflectionUtils.isGetter(isMethod)).isTrue();

        // Test non-getters
        Method setMethod = TestClass.class.getMethod("setActive", boolean.class);
        Method toStringMethod = Object.class.getMethod("toString");

        assertThat(ReflectionUtils.isGetter(setMethod)).isFalse();
        assertThat(ReflectionUtils.isGetter(toStringMethod)).isFalse();
    }
    ...
    void testIsSetter() throws NoSuchMethodException
    {
        ...
        assertThat(ReflectionUtils.isSetter(setMethod)).isTrue();

        // Test non-setters
        Method getMethod = TestClass.class.getMethod("getSomething");
        Method toStringMethod = Object.class.getMethod("toString");

        assertThat(ReflectionUtils.isSetter(getMethod)).isFalse();
        assertThat(ReflectionUtils.isSetter(toStringMethod)).isFalse();
    }
    ...
    void testIsStaticMethod() throws NoSuchMethodException
    {
        ...
        assertThat(ReflectionUtils.isStatic(staticMethod)).isTrue();
        assertThat(ReflectionUtils.isNonStatic(staticMethod)).isFalse();

        // Test non-static method
        Method nonStaticMethod = TestClass.class.getMethod("getSomething");

        assertThat(ReflectionUtils.isStatic(nonStaticMethod)).isFalse();
        assertThat(ReflectionUtils.isNonStatic(nonStaticMethod)).isTrue();
    }
    ...
    void testIsStaticField() throws NoSuchFieldException
    {
        ...
        assertThat(ReflectionUtils.isStatic(staticField)).isTrue();
        assertThat(ReflectionUtils.isNonStatic(staticField)).isFalse();

        // Test non-static field
        Field nonStaticField = TestClass.class.getDeclaredField("privateWithoutGetter");

        assertThat(ReflectionUtils.isStatic(nonStaticField)).isFalse();
        assertThat(ReflectionUtils.isNonStatic(nonStaticField)).isTrue();
    }
    ...
    void testGetFieldNameFromMethod() throws NoSuchMethodException
    {
        ...
        assertThat(ReflectionUtils.getFieldNameFromMethod(getMethod)).contains("something");
        assertThat(ReflectionUtils.getFieldNameFromMethod(isMethod)).contains("active");

        // Test setter method
        Method setMethod = TestClass.class.getMethod("setActive", boolean.class);

        assertThat(ReflectionUtils.getFieldNameFromMethod(setMethod)).contains("active");

        // Test non-getter/setter method
        Method toStringMethod = Object.class.getMethod("toString");

        assertThat(ReflectionUtils.getFieldNameFromMethod(toStringMethod)).isEmpty();
    }
    ...
    void testGetSetter()
    {
        ...
        assertThat(setter).isPresent();
        assertThat(setter.get().getName()).isEqualTo("setActive");

        // Test non-existing setter
        Optional<Method> nonExistingSetter = ReflectionUtils.getSetter(TestClass.class, "nonExisting");

        assertThat(nonExistingSetter).isEmpty();
    }
    ...
    void testGetField()
    {
        ...
        assertThat(field.get().getName()).isEqualTo("privateWithoutGetter");

        // Test non-existing field
        Optional<Field> nonExistingField = ReflectionUtils.getField(TestClass.class, "nonExisting");

        assertThat(nonExistingField).isEmpty();
    }
    ...
    void testGetAnnotationRecursive() throws NoSuchMethodException
    {
        ...
        assertThat(annotation.value()).isEqualTo("interface");
        ...
        assertThat(annotation).isNotNull();
        assertThat(annotation.value()).isEqualTo("base");
    ...
    void testGetSubject() throws NoSuchMethodException, NoSuchFieldException
    {
        ...
        // Test static method
        Method staticMethod = TestClass.class.getMethod("getStaticMethod");
        assertThat(ReflectionUtils.getSubject(staticMethod, testObject)).isNull();

        // Test non-static method
        Method nonStaticMethod = TestClass.class.getMethod("getSomething");
        assertThat(ReflectionUtils.getSubject(nonStaticMethod, testObject)).isSameAs(testObject);

        // Test static field
        Field staticField = TestClass.class.getDeclaredField("privateStaticWithoutGetter");
        assertThat(ReflectionUtils.getSubject(staticField, testObject)).isNull();

        // Test non-static field
        Field nonStaticField = TestClass.class.getDeclaredField("privateWithoutGetter");
        assertThat(ReflectionUtils.getSubject(nonStaticField, testObject)).isSameAs(testObject);
    }
    ...
    void testIsTerminalType()
    {
        ...
        assertThat(ReflectionUtils.isTerminalType(int.class)).isTrue();
        assertThat(ReflectionUtils.isTerminalType(boolean.class)).isTrue();

        // Test enum types (should be terminal)
        assertThat(ReflectionUtils.isTerminalType(java.time.Month.class)).isTrue();

        // Test array types (should NOT be terminal)
        assertThat(ReflectionUtils.isTerminalType(int[].class)).isFalse();
        assertThat(ReflectionUtils.isTerminalType(String[].class)).isFalse();
        assertThat(ReflectionUtils.isTerminalType(Object[].class)).isFalse();

        // Test special Java types (should be terminal)
        assertThat(ReflectionUtils.isTerminalType(java.util.Date.class)).isTrue();
        assertThat(ReflectionUtils.isTerminalType(java.util.UUID.class)).isTrue();

        // Test Java standard library types (should be terminal)
        assertThat(ReflectionUtils.isTerminalType(String.class)).isTrue();
        assertThat(ReflectionUtils.isTerminalType(Integer.class)).isTrue();

        // Test custom types (should NOT be terminal)
        assertThat(ReflectionUtils.isTerminalType(TestClass.class)).isFalse();
    }
    ...
    void testIsTerminalTypeWithObject()
    {
        ...
        assertThat(ReflectionUtils.isTerminalType("test")).isTrue();

        // Test with custom object
        assertThat(ReflectionUtils.isTerminalType(new TestClass())).isFalse();
    ...
    @Test
    void testIsTerminalType2() throws DatatypeConfigurationException
    {
        XMLGregorianCalendar xmlCal = DatatypeFactory.newInstance().newXMLGregorianCalendar("2030-12-31");
        assertThat(ReflectionUtils.isTerminalType(xmlCal)).isTrue();
    }
}
