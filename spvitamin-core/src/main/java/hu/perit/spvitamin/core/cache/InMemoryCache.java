...
///
/// This cache provides the following features:
///
///     - Thread-safe operations using locks to ensure data consistency during concurrent access
///     - Automatic validation of cached entities using the [#isValid()] method
///     - Lazy loading of values through supplier functions
///     - Optional maximum capacity with LRU (Least Recently Used) eviction policy
///
///
/// Usage example:
/// <pre>
...
/// </pre>
///
/// Note: All values stored in this cache must implement the [CacheableEntity] interface,
/// which provides the `isValid()` method to determine if a cached entity is still valid or needs to be refreshed.
///
/// @param <K> The type of keys maintained by this cache
/// @param <V> The type of cached values, must implement [CacheableEntity]
@Slf4j
